...
public class IPathTesterEditor : Editor
{
    ...
    //    var fmh_36_68_638586566343803029 = Quaternion.identity; Vector3 newStartPos = Handles.FreeMoveHandle(holder.start, 0.1f, Vector3.zero, Handles.CircleHandleCap);
    ...
    //    var fmh_44_64_638586566343818322 = Quaternion.identity; Vector3 newEndPos = Handles.FreeMoveHandle(holder.end, 0.1f, Vector3.zero, Handles.CircleHandleCap);
    ...
    //    Handles.color = Color.yellow;
    //    var fmh_114_69_638586566343820463 = Quaternion.identity; closestPosTarget = Handles.FreeMoveHandle(closestPosTarget, 0.1f, Vector3.zero, Handles.CircleHandleCap);
    //    var closest = holder.p.GetClosestPoint(closestPosTarget);
    //    var fmh_116_47_638586566343822874 = Quaternion.identity; Handles.FreeMoveHandle(closest.Item1, 0.05f, Vector3.zero, Handles.CircleHandleCap);
