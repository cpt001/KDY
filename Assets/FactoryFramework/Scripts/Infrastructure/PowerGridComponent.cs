...
namespace FactoryFramework
{
    ...
    public class PowerGridComponent : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                // with 1x1 quad we need its total size to be the diameter == 2*radius
                if (radiusVisual)
                    radiusVisual.transform.localScale = Vector3.one * connectionRadius * 2f;
            }
        }
        ...
        private void ManagePowerDraw()
        {
            ...
            basePowerDraw = (_logisticComponent.IsWorking) ? _powerDraw : 0f;
        }
